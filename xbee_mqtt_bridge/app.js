...
function pubblicaViaMqtt(mittente, contenuto) {
  var topic = '/zefiro/zigbee-mqtt-bridge/zigbee-rx/' + mittente;
...
function pubblicaEsitoTxViaMqtt(frameId, deliveryStatus) {
  var topic = '/zefiro/zigbee-mqtt-bridge/zigbee-tx-delivery';
  var payload = {
    frameId: frameId,
...
function pubblicaViaZigBee(topic, payload) {
  // /zefiro/zigbee-mqtt-bridge/mqtt-rx/<destinatario-zigbee>'
